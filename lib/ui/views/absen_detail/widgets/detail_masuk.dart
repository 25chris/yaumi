                        ...
                        TextSpan(children: [
                          TextSpan(
                              text: DateFormat("EEEE, ", "id_ID")
                                  .format(widget.datum.attributes!.date!),
                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        subtitle: Text(widget.datum.attributes!.jamMasuk!
                            .replaceRange(5, null, "")),
                      ),
                      ListTile(
                        leading: const Icon(Icons.abc),
                      ...
                      TimeCheckService.checkTimeInput(
                          ...
                          keterlambatanController: keterlambatanController,
                      ...
                      const ListTile(
                        ...
                        subtitle: Text("Gegerkalong Girang, Bandung"),
                      ),
                    ],
                  ),
                )),
...
class TimeCheckService {
  ...
  static Widget checkTimeStatus(String time) {
